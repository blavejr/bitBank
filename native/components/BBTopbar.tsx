...
export default function BBTopbar() {
  return (
    <View className="flex-row justify-between items-center ml-4 mr-4">
      <TouchableOpacity>
        <Image source={require('../assets/images/icon.png')} style={{ width: 50, height: 50, borderRadius: 50 }} />
      </TouchableOpacity>
      <View className="flex-row justify-between items-center gap-2 bg-gray-100 border border-gray-300 rounded-md p-1 w-1/2">
